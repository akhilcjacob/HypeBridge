            ...
            <div className="mt-24 bg-primary py-16 text-center text-white">
                <div className="container mx-auto max-w-4xl px-8">
                    ...
                    <p className="text-lg leading-relaxed">
                        HypeBridge uses advanced AI to revolutionize how brands connect with influencers.
                        Our mission is to streamline the influencer marketing process, making it easier for businesses
                        of all sizes to find and collaborate with the perfect creators. We are committed to providing a
                        user-friendly, data-driven platform that empowers both brands and influencers to succeed together.
                    </p>
                </div>
            </div>
        </section>
