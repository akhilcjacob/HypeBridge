...
export const AIFeaturesDiagonal = () => {
      ...
      >
        <div className="2xl:w-[1150px] xl:w-[1050px] md:w-4/5 flex justify-center bg-bgDark1 pt-12 lg:pt-24 pb-8 lg:pb-20 mx-auto lg:flex-row flex-col align-middle">
          <div className="w-3/4 lg:w-1/2 flex flex-col lg:mx-unset mx-auto">
            <span className="block-subtitle">AI-Powered Automation</span>
            <h2 className="mt-10 mb-8 text-4xl lg:text-5xl block-big-title">
              Let AI Run Your Campaigns
            </h2>
            <p className="mb-16 text-secondaryText leading-loose">
              Our autonomous AI agents handle everything - from finding the perfect influencers to
              negotiating deals and optimizing performance. Experience true hands-free influencer
              marketing powered by cutting-edge artificial intelligence.
            </p>
            <button
